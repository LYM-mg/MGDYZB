...
@objc
protocol MGToolBottomViewDelegate : NSObjectProtocol {
    optional func toolBottomView(toolBottomView:MGToolBottomView, type:ToolBarBtnType.RawValue)
}
