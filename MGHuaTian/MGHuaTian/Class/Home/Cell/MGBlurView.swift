...
@objc
protocol MGBlurViewDelegate : NSObjectProtocol {
    optional func blurView(blurView: MGBlurView, didSelectCategory category: AnyObject)
}


private let CategoryCellReuseIdentifier = "CategoryCellReuseIdentifier"
class MGBlurView: UIVisualEffectView , UITableViewDelegate, UITableViewDataSource,MallsCategoryHeaderDelagate{
    ...
    /// 代理
    weak var delegate : MGBlurViewDelegate?
