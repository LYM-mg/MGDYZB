...
class HearViewModel: BaseViewModel {
 ...
 */
    func loadHearderData(_ finishCallback: @escaping () -> ()) {
        let urlStr = "http://capi.douyucdn.cn/api/v1/live/\(tag_id)"
        let parameters: [String: Any] = ["limit": 20,"client_sys": "ios","offset": offset]
        loadAnchorData(isGroup: false, urlString: urlStr, parameters: parameters, finishedCallback: finishCallback)
    }
}
